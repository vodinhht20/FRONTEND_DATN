...
import { Avatar, Badge, Button, Card, Col, Form, List, Spin } from "antd";

const Order1 = ({fileImage, loadingSingle, inputImage, onchangleUpload, loading, order, onFinish, onFinishFailed, totalVacations, totalText, RangePicker, CountTotal, disabledDate, locale, TextArea, Upload, props, loadingApprover, approver}) => {
